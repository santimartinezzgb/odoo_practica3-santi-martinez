...
\begin{itemize}
        ...
        \item \textbf{Documentación oficial de Odoo}: \url{https://www.odoo.com/documentation/}
        ...
        \item \textbf{Crear una portada bonita en Latex}: \url{https://manualdelatex.com/tutoriales/crear-una-portada}
        ...
        \item \textbf{Para xml}: \url{https://www.odoo.com/documentation/15.0/developer/reference/backend/views.html}
        
        \item \textbf{Herencia de modelos en Odoo}: \url{https://www.cybrosys.com/blog/model-inheritance-in-odoo}
        ...
        \item \textbf{ClaudeAI (apoyo en la actualización del módulo Lista de tareas)}: \url{https://claude.ai/}
    \end{itemize}
