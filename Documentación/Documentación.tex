...
\title{\Huge \textbf{Documentación Práctica 3}}
    ...
    \section{Modificación del módulo "Lista de tareas"}
        ...
        \subsection{Actualización del módulo}
            ...
            \begin{itemize}
                ...
                \item \textbf{action\_completar:} Cambia el estado de ka tarea a 'completada' y el campo \textbf{completada} lo pasa a true.

                \item \textbf{action\_cancelar:} Modifica el estado a 'cancelada'. Este método permite al usuaroi eliminar/cancelar tareas.
