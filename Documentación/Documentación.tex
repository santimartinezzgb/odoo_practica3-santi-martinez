...
debug/hmdmhilocobgohohpdpolmibjklfgkbi?hl=es_PR}
    ...
    \section{Creación de módulos en Odoo}
        ...
        \begin{itemize}
            ...
            \item \textbf{\_\_manifest\_\_.py}: es el manifiesto del módulo. Incluye información como el título, descripción, así como ficheros a cargar. En el ejemplo se debe descomentar la línea que contiene la lista de control de acceso en el fichero \textbf{security/ir.model.access.csv}.
        \end{itemize}
